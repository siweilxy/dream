...
{
    BOOST_LOG_SEV(slg, critical)<<RED<<file<<" "<<line<<" "<<message<<END;
}

void log::Notification(int line, std::string&& file, std::string&& message)
{
    BOOST_LOG_SEV(slg, notification)<<BLUE<<file<<" "<<line<<" "<<message<<END;
}
...
{
    BOOST_LOG_SEV(slg, error)<<VIOLET<<file<<" "<<line<<" "<<message<<END;
}

void log::Warning(int line, std::string&& file, std::string&& message)
{
    BOOST_LOG_SEV(slg, warning)<<YELLOW<<file<<" "<<line<<" "<<message<<END;
}
